...
public class MemControl 
{
	...
	public MemControl()
	{
		try
		{
			...
			rowSet.setCommand("SELECT memID, memFname, memLname, memStreet, memZip, memState, memHome, memCell, memGen, memAge, memBirth, memJoin, memFee, memType FROM Mem_List ORDER BY memID");
			rowSet.execute();
